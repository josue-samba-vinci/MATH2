...
public class TestRelation {
	...
	private static boolean testCloReflex() {
		...
		Relation copieDg1 = dg1.clone();
		dg1.cloReflex();
		copieDg1.ajouter(new Couple(new Elt(4), new Elt(4)));
		copieDg1.ajouter(new Couple(new Elt(6), new Elt(6)));
		copieDg1.ajouter(new Couple(new Elt(8), new Elt(8)));
		copieDg1.ajouter(new Couple(new Elt(10), new Elt(10)));
		copieDg1.ajouter(new Couple(new Elt(12), new Elt(12)));
		copieDg1.ajouter(new Couple(new Elt(14), new Elt(14)));

		for (int i = 16; i <= 23; i++) {
			copieDg1.ajouter(new Couple(new Elt(i), new Elt(i)));
		}

		copieDg1.ajouter(new Couple(new Elt(29), new Elt(29)));
		copieDg1.ajouter(new Couple(new Elt(31), new Elt(31)));
		copieDg1.ajouter(new Couple(new Elt(33), new Elt(33)));
		copieDg1.ajouter(new Couple(new Elt(35), new Elt(35)));

		for (Elt eD : copieDg1.depart()) {
			for (Elt eA : copieDg1.arrivee()) {
				if (copieDg1.contient(eD, eA) != dg1.contient(eD, eA)) {
					testOK = false;
					System.out
							.println("On a fait la clôture réflexive de la relation dg1");
					if (copieDg1.contient(eD, eA)) {
						System.out
								.println("Le couple ("
										+ eD
										+ ","
										+ eA
										+ ") aurait dû être ajouté à la relation dg1 et ce n'est pas le cas.");
					} else {
						System.out
								.println("Le couple ("
										+ eD
										+ ","
										+ eA
										+ ") n'aurait pas dû être ajouté à la relation dg1.");
					}
					break;
				}
			}
